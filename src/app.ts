...
app.get("/delete-account", (req, res) => {
  res.send(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>Удаление аккаунта — МигРабота</title></head><body style="font-family:Arial;max-width:800px;margin:40px auto;padding:0 20px"><h1>Удаление аккаунта МигРабота</h1><p>Приложение МигРабота, разработанное Отгонцэцэг Бекболот.</p><h2>Как удалить аккаунт</h2><p>1. Откройте приложение МигРабота и войдите в свой аккаунт.</p><p>2. Перейдите в раздел «Профиль».</p><p>3. Нажмите «Удалить аккаунт» внизу экрана.</p><p>4. Подтвердите удаление в появившемся окне.</p><p>Если у вас нет доступа к приложению, отправьте запрос на удаление на migrabota@gmail.com с указанием номера телефона, привязанного к аккаунту.</p><h2>Какие данные удаляются</h2><p>При удалении аккаунта безвозвратно удаляются: имя, фотография профиля, номер телефона, история смен и откликов, рейтинг AI Score, загруженные документы.</p><h2>Какие данные сохраняются</h2><p>Записи о завершённых финансовых транзакциях сохраняются в обезличенном виде в течение 3 лет в соответствии с требованиями бухгалтерского учёта.</p><h2>Срок обработки запроса</h2><p>Запрос обрабатывается в течение 30 дней с момента подачи.</p><h2>Контакты</h2><p>По вопросам удаления данных: migrabota@gmail.com</p></body></html>`);
});
